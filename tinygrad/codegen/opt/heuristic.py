...
def hand_coded_optimizations(k:Scheduler) -> Scheduler:
  ...
  cpu_matmul = is_cpu_with_threads and k.reduceop is not None
  ...
  # CPU: try larger upcast amounts first (8,4) for better cache efficiency
  # CPU matvec: use more accumulators for ILP to hide memory latency
